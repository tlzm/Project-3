...
vae.fit(fea_array, fea_array,epochs=5000,batch_size=50,shuffle=True,validation_split=0.1, verbose=1,
          callbacks = [keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=0, patience=1000,verbose=0, mode='min'),
