...
d11 = pd.DataFrame({'id': d11['id']-1802,'haccel':d11['haccel'],'vaccel':d11['vaccel'],'RUL':d11['RUL']})
d12 = pd.DataFrame({'id': d12['id'],'haccel':d12['haccel'],'vaccel':d12['vaccel'],'RUL':d12['RUL']})
d13 = pd.DataFrame({'id': d13['id']-1374,'haccel':d13['haccel'],'vaccel':d13['vaccel'],'RUL':d13['RUL']})
d14 = pd.DataFrame({'id': d14['id']-427,'haccel':d14['haccel'],'vaccel':d14['vaccel'],'RUL':d14['RUL']})
d15 = pd.DataFrame({'id': d15['id']-1462,'haccel':d15['haccel'],'vaccel':d15['vaccel'],'RUL':d15['RUL']})
d16 = pd.DataFrame({'id': d16['id']-1447,'haccel':d16['haccel'],'vaccel':d16['vaccel'],'RUL':d16['RUL']})
d17 = pd.DataFrame({'id': d17['id']-1258,'haccel':d17['haccel'],'vaccel':d17['vaccel'],'RUL':d17['RUL']})
